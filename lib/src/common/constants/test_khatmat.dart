...
var kTestKhatmat = [
  Khatma(
    ...
    parts: [
      KhatmaPart(id: 1, readerName: 'Ahmed', finishedDate: DateTime.now()),
      KhatmaPart(id: 2, readerName: 'Ahmed', finishedDate: DateTime.now()),
      KhatmaPart(id: 3, readerName: 'Ahmed', finishedDate: DateTime.now()),
    ],
