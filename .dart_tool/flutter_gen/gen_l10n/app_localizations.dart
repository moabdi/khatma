...
abstract class AppLocalizations {
  ...
  ///
  /// In en, this message translates to:
  /// **'You reviewed this khatma before. You can edit your review.'**
  ...
  /// Message for khatma fields that can't be empty
  ///
  /// In en, this message translates to:
  /// **'Can\'t be empty'**
  ...
  /// No description provided for @khatmaUpdated.
  ///
  /// In en, this message translates to:
  /// **'Product updated'**
  String get khatmaUpdated;

  /// No description provided for @couldNotSaveProduct.
  ///
  /// In en, this message translates to:
  /// **'Could not save khatma data'**
  ...
  /// The quantity of the khatma to be added to the cart
  ///
  /// In en, this message translates to:
  /// **'Quantity: {quantity}'**
